...
3. [Realizar un programa que presente un menú con opciones para:
   ...
   NOTA: El nombre del archivo a crear o utilizar debe ser proporcionado por el usuario una única vez.](https://github.com/leoroan/UNLP-FOD/tree/PRACTICA1/P1/P1-3)
...
4. [Agregar al menú del programa del ejercicio 3, opciones para:
   ...
   NOTA: Las búsquedas deben realizarse por número de empleado.](https://github.com/leoroan/UNLP-FOD/tree/PRACTICA1/P1/P1-4)
...
6. [Agregar al menú del programa del ejercicio 5, opciones para:
   ...
   NOTA: Las búsquedas deben realizarse por nombre de celular.](https://github.com/leoroan/UNLP-FOD/tree/PRACTICA1/P1/P1-6)
